...
if __name__ == "__main__":
    files = ['./Data/wc+rs-3d-c4-obj1.csv', './Data/wc+rs-3d-c4-obj2.csv', './Data/wc+sol-3d-c4-obj1.csv', './Data/wc+sol-3d-c4-obj2.csv', './Data/wc+wc-3d-c4-obj1.csv', './Data/wc+wc-3d-c4-obj2.csv']
    results = {}
    for file in files:
        results[file] = {}
        print file,
    ...
    pickle.dump(results, open("/Users/viveknair/GIT/Reimplement/WHAT/progressive_sampling/data/save3.p", "wb"))